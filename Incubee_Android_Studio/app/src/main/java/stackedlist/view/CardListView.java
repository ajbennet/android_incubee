...
import stackedlist.view.Orientations.Orientation;


public class CardListView extends AdapterView<ListAdapter> {
	...
	private CardEventsListener mListener;
	
	public void setCardEventListener(CardEventsListener listener){
		mListener = listener;
	}
